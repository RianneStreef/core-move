      ...
      <Layout>
        <div className="content">
          ...
          <p>
            ...
            allemaal wel een keer gehoord. Een of twee uur in de sportschool per
            week zet vaak maar even of niet genoeg zoden aan de dijk. Men krijgt
            niet de juiste begeleiding waardoor klachten ontstaan en dat
            demotiveert om te bewegen. Daarbij komt dat als je een inactieve
            leefstijl hebt, 1 keer per week naar de sportschool juist een
            grotere kans geeft op blessures. en dus het effect uit zal blijven.
          </p>
          <p>
            ...
            vele zitten. 55% van onze kinderen van 0 tot en met 18 jaar halen de
            bewegingsnorm NIET. Dit bestaat uit een uurtje bewegen per dag wat
            meer dan de helft van onze kinderen (dus ook baby’s, peuters en
            kleuters al) niet haalt. Persoonlijk gaat me dit erg aan het hart.
            De gevolgen van op jonge leeftijd niet genoeg bewegen zijn immens.
            Van de heftige gevolgen zoals onder andere obesitas met alle
            gevolgen van dien - diabetes type2 op jonge leeftijd, tot het niet
            goed ontwikkelen van de motoriek wat op fysiek en psychisch gebied
            negatieve gevolgen kan hebben. Niet alles is omkeerbaar. Maar de
            regel geldt; bewegen is goed - meer bewegen is beter. Op welke
            leeftijd dan ook. Het is nooit te laat om te starten. Kijk naar het
            bewegen als één geheel. Wat heeft jouw lijf nodig? Bij de eerste
            intake wordt hier een plaatje van gemaakt. Er wordt onder andere
            gekeken naar:
          </p>
          <ul>
